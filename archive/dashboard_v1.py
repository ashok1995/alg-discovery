...
def get_all_stocks_level():
    ...
    sam_q = '( {cash} ( latest "sum ( close  *  volume, 5 ) / sum ( volume ,5 )" > latest "sum ( close  *  volume, 10 ) / sum ( volume ,10 )" and latest close > 20 and abs ( latest open - latest close ) > latest close * .005 ) )'
    sample_q2 = '( {cash} ( [0] 30 minute close > [0] 30 minute ema ( [0] 30 minute close , 8 ) and [0] 30 minute close > [0] 30 minute ema ( [0] 30 minute close , 34 ) and [0] 30 minute close > [0] 30 minute ema ( [0] 30 minute close , 100 ) and [0] 30 minute ema ( [0] 30 minute close , 8 ) > [0] 30 minute ema ( [0] 30 minute close , 34 ) and [0] 30 minute ema ( [0] 30 minute close , 34 ) > [0] 30 minute ema ( [0] 30 minute close , 100 ) and [0] 30 minute adx ( 14 ) > 25 and [0] 30 minute adx di positive ( 14 ) > [0] 30 minute adx di negative ( 14 ) and [0] 30 minute volume > [0] 30 minute sma ( [0] 30 minute volume , 20 ) and [0] 30 minute volume > [0] 30 minute sma ( [0] 30 minute volume , 10 ) and weekly close > 1 week ago high and [0] 30 minute sma ( [0] 30 minute volume , 2 ) * latest close > 20000000 and [0] 30 minute rsi  ( 14 ) > 50 and [0] 30 minute macd line ( 26 , 12 , 9 ) > [0] 30 minute macd signal ( 26 , 12 , 9 ) ) ) '
    sample_q3 = '( {cash} ( [0] 5 minute close > [0] 5 minute ema ( close,8 ) and [0] 5 minute close > [0] 5 minute ema ( close,34 ) and [0] 5 minute close > [0] 5 minute ema ( close,100 ) and [0] 5 minute ema ( close,8 ) > [0] 5 minute ema ( close,34 ) and [0] 5 minute ema ( close,34 ) > [0] 5 minute ema ( close,100 ) and [0] 10 minute adx ( 14 ) >= 30 and [0] 10 minute adx di positive ( 14 ) > [0] 10 minute adx di negative ( 14 ) and [0] 5 minute volume > [0] 5 minute sma ( close,20 ) and [0] 5 minute volume > [0] 5 minute sma ( close,10 ) and [0] 5 minute rsi  ( 14 ) > 50 and [0] 10 minute rsi  ( 14 ) > 50 and [0] 5 minute macd line ( 26 , 12 , 9 ) > [0] 5 minute macd signal ( 26 , 12 , 9 ) and [0] 10 minute macd line ( 26 , 12 , 9 ) > [0] 5 minute macd signal ( 26 , 12 , 9 ) and latest close > latest sma ( close,7 ) and [0] 5 minute "ema( [0] 5 minute volume, 10 )" * latest close > 10000000 and [0] 5 minute close > [-1] 5 minute close ) ) '
...
def filter_by_tvolcr(df, threshold):
    return df[df['TVolCr'] > threshold]
...
with col1:
    ...
    with filter_col:
        # Input for filtering TVolCr
        tvolcr_input = st.number_input("Filter TVolCr greater than:", min_value=0, value=0, key='tvolcr_input')

    if tvolcr_input > 0:
        filtered_df = filter_by_tvolcr(stock_data, tvolcr_input)
    else:
