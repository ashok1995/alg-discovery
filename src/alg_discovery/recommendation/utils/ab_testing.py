...
# Locate default ab_tests.json
_DEFAULT_AB_TESTS_PATH = (files("alg_discovery.recommendation.config") / "ab_tests.json").as_posix()
...
class ABTestingFramework:
    ...
    def __init__(self, config_path: str = _DEFAULT_AB_TESTS_PATH):
        """
