...
# Locate default chartink_filters.json
_DEFAULT_FILTERS_PATH = (
...
class ChartinkFilterManager:
    ...
    def __init__(self, config_path: str = _DEFAULT_FILTERS_PATH):
        """
...
class ChartinkStockFetcher:
    ...
    def __init__(self, cache_duration_minutes: int = 5,
                 filter_config_path: str = _DEFAULT_FILTERS_PATH):
        """
