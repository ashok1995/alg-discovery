...
# --------------------------------------------------------------
# Robust import for APILogger similar to long-term server
# --------------------------------------------------------------

try:
    from utils.api_logger import APILogger
except ModuleNotFoundError:  # Fallback when module path differs
...
if __name__ == "__main__":
    ...
    warn(
        "Running 'shortterm_server' directly is deprecated. Use the central FastAPI app.",
        DeprecationWarning,
    ) 