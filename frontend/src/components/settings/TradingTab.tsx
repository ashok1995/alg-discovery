        ...
        <Card>
          <CardContent>
            ...
            <TextField
              ...
              onChange={(e) => onSettingChange('refreshInterval', parseInt(e.target.value) || 0)}
              margin="normal"
            ...
            <TextField
              ...
              onChange={(e) => onSettingChange('maxPositions', parseInt(e.target.value) || 0)}
              margin="normal"
            />
            <TextField
              fullWidth
        ...
        <Card>
          <CardContent>
            ...
            <TextField
              ...
              onChange={(e) => onSettingChange('marketHours', { ...settings.marketHours, start: e.target.value })}
              margin="normal"
            ...
            <TextField
              ...
              onChange={(e) => onSettingChange('marketHours', { ...settings.marketHours, end: e.target.value })}
              margin="normal"
              InputLabelProps={{ shrink: true }}
            />
          </CardContent>
