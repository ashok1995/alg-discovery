...
# Recommendations (GET; trade_type required)
...
Response: `RecommendationsResponse` — `trade_type`, `count`, `recommendations: RankedStockResponse[]`, `generated_at`.  
...
| `/v2/learning/score-bin-performance` | GET | SeedDashboardService.getScoreBinPerformance | Dashboard → ML/Learning tab |
